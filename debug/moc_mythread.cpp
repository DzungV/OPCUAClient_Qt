...
QT_MOC_LITERAL(1, 9, 12), // "NumberChange"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "MyThread\0NumberChange\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NumberChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::NumberChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::NumberChange(int _t1)
{
